...
const PHONE_NUMBER = "+918668322633";
const WHATSAPP_NUMBER = "918668322633";

const FloatingContactButtons = () => {
  const whatsappText =
    "Hi! I am interested in booking a stay at Pavana Agro Tourism. Please share availability and offers.";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      <a
        ...
        aria-label="Call Pavana Agro Tourism"
      >
